...
<div id="wrapper">
		...
		<div id="content">
				...
				<p>
						...
						Hello and welcome to Typography Paramount, a light, nifty little template created by <a href="http://www,sixshootermedia.com">Six Shooter Media</a>. This template has a slight twist to it and that is that it includes no images what-so-ever. This results in a page which loads lightning fast and displays consistently on various browsing mediums.
		...
		<div id="footer">
								...
								© All your copyright information here.</p><br /><br /><script type="text/javascript"><!--
ch_client = "JayKoster";
ch_width = 728;
ch_height = 90;
