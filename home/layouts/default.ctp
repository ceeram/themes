...
<h1 class="main_title"><a href="#">Home - Free CSS Template by Six Shooter Media</a></h1>
...
<p class="note">
Hello and welcome to 'Home' (aptly named I would imagine!) a free web template designed by <a href="http://www.sixshootermedia.com">Six Shooter Media</a>. It's a fairly simple template, but I hope you enjoy it none-the-less!
</p>

<h2>Examples</h2>
<p>
Here are some examples of common web elements which you are more than likely to user in your own web site. I've laid a few down here, a few otehrs are taken care of in the style sheet also.
</p>
